 ...
 */
export const employee: Resolver<QueryEmployeeArgs> = async (_parent, args, { prisma }) => {
 ...
 */
export const employees: Resolver<QueryEmployeesArgs> = async (_parent, { filter }, { prisma }) => {
 ...
 */
export const createEmployee: Resolver<MutationCreateEmployeeArgs> = async (_, args, { prisma }) => {
  const {
 ...
 */
export const updateEmployee: Resolver<MutationUpdateEmployeeArgs> = async (_, args, { prisma }) => {
  const { input } = args;
  const { id, ...rest } = input;
 ...
 * @returns status of operation (ok)
 */
export const deleteEmployee: Resolver<MutationDeleteEmployeeArgs> = async (_, args, { prisma }) => {
