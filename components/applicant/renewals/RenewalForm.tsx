import { useState, useEffect, useCallback, FC } from 'react'; // React
...
const RenewalForm: FC = () => {
  ...
  const handleCompletePersonalInformationStep = useCallback(
    (values: {
  ...
  const handleCompleteContactInformationStep = useCallback(
    (values: {
  ...
  const handleCompleteDoctorInformationStep = useCallback(
    (values: {
