...
import EditDoctorInformationModal from '@components/admin/requests/modals/EditDoctorInformationModal'; // Edit modal
import { Physician, UpdateApplicationInput } from '@lib/graphql/types'; // GraphQL types
import { DoctorInformationCardPhysician } from '@tools/components/admin/requests/doctor-information-card'; // Physician type
