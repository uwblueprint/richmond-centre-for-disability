...
declare namespace ShopifyBuy {
  ...
  export interface CheckoutResource {
     ...
     */
    removeLineItems(checkoutId: string | number, lineItems: CheckoutLineItemInput[]): Promise<Cart>;

    /**
     * Updates line items on an existing checkout.
     */
    updateLineItems(checkoutId: string | number, lineItems: CheckoutLineItemInput[]): Promise<Cart>;
     ...
     * */
    addGiftCards(checkoutId: string | number, giftCardCodes: string[]): Promise<Cart>;

    /**
     * Remove a gift card from an existing checkout
     */
    removeGiftCard(checkoutId: string | number, appliedGiftCardId: string): Promise<Cart>;
